...
namespace org
{
    namespace ortc
    {
        namespace adapter
        {
            ...
            class SDPConvertor
            {
                internal static void parseSDP(string sdp, out string sessionId, out string sessionVersion,
                    out string streamId, out bool audioSupported, out bool videoSupported, out string ice_ufrag,
                    out string ice_pwd, out string fingerprint, List<Dictionary<string, string>> extmaps,
                    List<string> codecs)
                {
                    bool valid = true;
                    ...
                    valid = parseCommonSdp(parts[0], out sessionId, out sessionVersion, out streamId, out audioSupported,
                        out videoSupported);
