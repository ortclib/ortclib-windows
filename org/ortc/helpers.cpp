...
#pragma region Enum Conversion
      ...
      const char *Helper::ToComponent(Log::Component  component)
      {
        ...
        case Log::Component::Services:                      return "ortc_services";
        case Log::Component::ServicesDns:                   return "ortc_services_dns";
        case Log::Component::ServicesHttp:                  return "ortc_services_http";
        case Log::Component::ServicesWire:                  return "ortc_services_wire";
        case Log::Component::ServicesStun:                  return "ortc_services_stun";
        case Log::Component::ServicesTurn:                  return "ortc_services_turn";
